...
const { genixDogeAutxAccessKey, genixDogeAutxSecretKey, genixDogeGravAccessKey, genixDogeGravSecretKey, genixDogeArbLoop, genixDogeArbMarket, genixDogeArbSpread, genixDogeArbVol } = require('./config.json');

// Config Access Keys
autradex.accessKey = genixDogeAutxAccessKey;
autradex.secretKey = genixDogeAutxSecretKey;
graviex.accessKey = genixDogeGravAccessKey;
graviex.secretKey = genixDogeGravSecretKey;
var loop = genixDogeArbLoop;

// Config Market
setInterval(function() {
	console.log("_________Beginning Arb Discovery For Raven vs Bitcoin_________");
	var theMarket = "genixdoge";
	var theMarketAutx = "dadoge";
	var increase = genixDogeArbSpread;
	var volume = genixDogeArbVol;
