...
const { ltcBtcAutxAccessKey, ltcBtcAutxSecretKey, ltcBtcGravAccessKey, ltcBtcGravSecretKey, ltcBtcArbLoop, ltcBtcArbMarket, ltcBtcArbSpread, ltcBtcArbVol } = require('./config.json');

// Config Access Keys
// Autradex
autradex.accessKey = ltcBtcAutxAccessKey;
autradex.secretKey = ltcBtcAutxSecretKey;
// Graviex
graviex.accessKey = ltcBtcGravAccessKey;
graviex.secretKey = ltcBtcGravSecretKey;
// Loop Time in Seconds
var loop = ltcBtcArbLoop;

// Config Market
setInterval(function() {
	console.log("_________Beginning Arb Discovery for Doge vs Bitcoin_________");
	var theMarket = "ltcbtc";
	var increase = ltcBtcArbSpread; // The most allowed increase in overlap
	var volume = ltcBtcArbVol; // The volume you wish to trade with
